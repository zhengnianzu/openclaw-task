...
# ClaudeCode
python harness_automation.py --harness claude-code --config configs/config_simple.json
python harness_automation.py --harness claude-code --config configs/config_user.json
python harness_automation.py --harness claude-code --config configs/config_simple_eval.json
